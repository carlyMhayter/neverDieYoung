...
export const aboutCardsInfo = {
  ...
  card3: {
    ...
    minorText:
      "Godwin has worked with such notable artists as Air Supply, Laura Brannigan, Shelby Lynne, Tanya Tucker in the house band for Fox’s Sunday Comics as well as numerous TV and Movie projects.",
    buttonLinkname: "",
    buttonText: "",
    imgId: "tim",
    scroll: true,
